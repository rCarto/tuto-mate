...
```{r osm, echo=TRUE, eval=TRUE, prompt=FALSE, message=FALSE, results='hide'}
...
<small>
```{r grid, echo=TRUE, eval=TRUE, prompt=FALSE, message=FALSE, results='hide'}
library(cartography)
library(sp)
data(nuts2006)
...
<small>
```{r disc, echo=TRUE, eval=TRUE, prompt=FALSE, message=FALSE, results='hide'}
...
<small>
```{r smooth, echo=TRUE, eval=TRUE, prompt=FALSE, message=FALSE, results='hide'}
# Create a grid layer
nuts3.spdf@data = nuts3.df
